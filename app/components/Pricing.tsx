        ...
        <div className="py-[48px] lg:py-[60px]">
           ...
           <div className="flex flex-col gap-y-6 gap-x-[24px] lg:flex-row">
            ...
            <div className="w-full rounded-[8px] bg-[#F5F4FF] p-6 flex flex-col lg:justify-between">
                <div>
                    <h3 className="font-medium text-[#4328EB] text-[18px] lg:text-xl"> Free Trail</h3>
                ...
                <div>
                    ...
                    <ul className="flex flex-col gap-y-2 pt-4 text-[#F4F8FA] ">
                         ...
                         <li className="flex items-center gap-x-2">
                            ...
                            Lorem ipsum dolor sit amet
                         </li> <li className="flex items-center gap-x-2">
                            <span>
                                <Image src={Check} alt="included" />
                            </span>
                            Lorem ipsum dolor sit amet
            ...
            <div className="w-full rounded-[8px] bg-[#F5F4FF] p-6 flex flex-col lg:justify-between">
                <div>
                 ...
                 <p className="pt-4 text-[16px] text-[#36485C]">Lorem ipsum dolor sit amet. Consectetur adipiscing elit, sed do
                 eiusmod tempor incididunt ut labore.</p>
                 <p className="pt-2 text-[16px] text-[#36485C]"> Get a birds eye view with our customizable dashboard. Stay on top of
