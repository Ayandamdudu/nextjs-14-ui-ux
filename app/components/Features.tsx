...
export function Features(){
    return(
      <div className="flex flex-col gap-y-[50px] py-[56px] lg:py-[120px] lg:gap-y-[80px]">
         ...
         <div className='sm:w-1/2 lg:py-[56px] lg:pr-[56px]'>
            ...
            <h1 className="pt-[12px] text-2xl font-medium tex-[#172026] lg:text-[42px] lg:leading-[58px]"> Simplify your sales monitoring</h1>
                <Image src={Feature1} alt='feature 1 image' className='pt-[24px] sm:hidden'  />
              <p className='py-[24px] text-[#36485C] lg:text-[18px]'>
                Stay on top of things and revamp your work process with our 
                game-changing fearure. Get a birds eye view with our customizable
                dashboard.
                </p> 

                <ul className='flex flex-col gap-y-3 lg:text-[18px]'>
                  <li className='flex items-center gap-x-2 text-[#34685C]'>
                     <span><Image src={Check} alt='Checkmark' />
                     </span>
         ...
         <div className='sm:w-1/2 lg:py-[56px] lg:pl-[56px]'>
            ...
            <h1 className="pt-[12px] text-2xl font-medium tex-[#172026] lg:text-[42px] lg:leading-[58px]"> Get in touch with your customer</h1>
         ...
         <div className='sm:w-1/2 lg:py-[56px] lg:pr-[56px]'>
            ...
            <h1 className="pt-[12px] text-2xl font-medium tex-[#172026] lg:text-[42px] lg:leading-[58px]">Monitor your sits new subscribers</h1>
              ...
              <p className='py-[24px] text-[#36485C] lg:text-[18px]'>
                ...
                dashboard.
                  ...
                  <div className='flex w-full gap-x-[24px]'>
                   ...
                   <p className='text-[#36585C]'>Lorem ipsum dolor sit</p>
                     </div>
                     <div className='w-1/2 flex flex-col gap-y-3'>
                    <h3 className='text-[20px] font-medium text-[#172026]'>800+</h3>
                    <p className='text-[#36585C]'>Conse adipiscing elit</p>
                     </div>
                  </div>
