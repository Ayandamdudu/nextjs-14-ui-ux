...
<div className="pt-4 lg:pt-10">
        <div className="px-[20px] lg:px-[280px]">
                    <h1 className="text-center text-[32px] leading-[40px] font-medium text-[#172026] lg:text-[64px] lg:leading-[72px]"> Start monitoring your website like pro</h1>
        ...
        <div className="flex w-full pt-8 justify-center gap-6">
            ...
            <button className="w-1/2 text-[#4328EB] flex items-center justify-center gap-x 2 lg:w-fit">
                View Pricing
                <span>
                    <Image src={BlurArrow} alt="Learn more" ></Image>
                </span>
            </button>
        </div>
     </div>
   ...
   <div className="relative flex h-full w-full justify-center">
     ...
     <div className="absolute bottom-5 flex w-flex flex-col items-center ">
        <Image src={HeroImage} alt="hero image" className="-ml-4 h-[310px] sm:-mb-[20] sm:h-[400px]lg:-mb-[28] lg:h-auto xl:w-[70%]" />

        <div className="flex w-full flex-col items-center lg:container lg:flex-row lg:justify-between lg:px-8">
